...
// balacing, the balancer also takes care of transparently switching from one
...
// promethus metrices. You can use prometheus+grafana to get detailed insights
...
// programtically and passed to balancer system components. Websocket balancer
...
// higher precedence. Following is the example of wsbalancer CLI help text as of
// now (please always refer to help o/p of latest balancer that you have since
// this documentation may be out of date in this regard)
//
//  $ wsbalancer -help
//    -config string
...
//    FE_RB_SIZE int
//          WebSocket ReadBuffer size (default "1024")
//    FE_WB_SIZE int
//          WebSocket WriteBuffer size (default "1024")
//    FE_TRUST_XFF bool
//          Weather to trust X-Forwarded-For header from clients (default "true")
//    BLOCK_HEADERS slice
//          Additional headers to block
...
// When to Use
//
// You should use wsbalancer if you need peristent connection from remote end
...
// to your server again than any standard HTTP reverse proxy with ordinary load
